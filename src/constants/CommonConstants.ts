/**
 * This class contains common constants which will required in across the framework
 *
 * @export
...
export class CommonConstants {
    ...
    static readonly REPORT_TITLE = "Sanity Test Execution Report";
    static readonly RESULTS_PATH = "./test-results/results";
    static readonly LOGGER_PATH = "test-results/results/logs/executionLog.log";
